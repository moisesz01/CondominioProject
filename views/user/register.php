			...
			<?php $form = ActiveForm::begin(["method" => "post",'enableClientValidation' => true]); ?>
					...
					<div class="col-sm-10">
						<?= $form->field($model, 'nombre', [
							'enableAjaxValidation' => true,
							'inputOptions' => ['placeholder' => 'Ingrese su nombre'],
					        'inputTemplate' => '<div class="input-group"><span class="input-group-addon"> <span class="glyphicon glyphicon-user"></span></span>{input}</div>',
					    ]); ?>
					</div>
					<div class="col-sm-10">
						<?= $form->field($model, 'apellido', [
							'enableAjaxValidation' => true,
							'inputOptions' => ['placeholder' => 'Ingrese su apellido'],
					        'inputTemplate' => '<div class="input-group"><span class="input-group-addon"> <span class="glyphicon glyphicon-user"></span></span>{input}</div>',
					    ]); ?>
					</div>
					<div class="col-sm-10">
						<?= $form->field($model, 'cedula', [
							'enableAjaxValidation' => true,
							'inputOptions' => ['placeholder' => 'Ingrese su Cédula de Identidad'],
					        'inputTemplate' => '<div class="input-group"><span class="input-group-addon"> <span class="glyphicon glyphicon-user"></span></span>{input}</div>',
					    ]); ?>
					</div>
					<div class="col-sm-10">
					...
					<div class="col-sm-10">
						<div class="form-group">
							<?= Html::submitButton("Continuar", ['class' => 'btn btn-success', 'style'=>'border:none;']) ?>
						</div>
					</div>
